...
def process_video(input_video_path, output_video_path, model_path='yolo11m.pt', conf=0.5, device='cuda'):
...
if __name__ == "__main__":
    input_video = "Marco 2025\YOLO\assets\video\VideoB.mp4"  # Caminho do vídeo de entrada
